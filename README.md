...
1. [Подтверждение](#1)
2. [Включение позиции/особой позиции в опубликованный в ЕИС план-график](#2)
3. [Формирование извещения (Электронный аукцион). Подача ценовых предложений](#3)
4. [Стадия "Заключение контракта](#4)

## Подтверждение <a id="1"></a>
...
## Включение позиции/особой позиции в опубликованный в ЕИС план-график <a id="2"></a>
...
## Формирование извещения (Электронный аукцион). Подача ценовых предложений <a id="3"></a>

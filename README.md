...
## Включение позиции/особой позиции в опубликованный в ЕИС план-график ##
...
## Формирование извещения (Электронный аукцион). Подача ценовых предложений ##

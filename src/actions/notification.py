...
def ep_notification_ef_2020(outgoing_xml):
    ...
    return template.find('.//ns5:commonInfo/ns5:purchaseNumber', ns).text


def ep_notification_ef_2020_final(outgoing_xml):
    """
    """
    ...
    template.find('.//ns7:commonInfo/ns7:purchaseNumber', ns).text = ep_notification_ef_2020(outgoing_xml)

...
def contract_procedure(outgoing_xml):
    ...
    template.find('.//ns2:fulfilledCost', ns).text = tree.find('.//ns2:fulfilledCost', ns).text
    ...
    template.find('.//ns2:payDoc/ns2:documentName', ns).text = tree.find(
        './/ns2:payDoc/ns2:documentName', ns).text
    template.find('.//ns2:payDoc/ns2:documentDate', ns).text = tree.find(
        './/ns2:payDoc/ns2:documentDate', ns).text
    template.find('.//ns2:payDoc/ns2:documentNum', ns).text = tree.find(
        './/ns2:payDoc/ns2:documentNum', ns).text
    ...
    template.find('.//ns2:docAcceptance/ns2:code', ns).text = tree.find('.//ns2:docAcceptance/ns2:code', ns).text
    ...
    template.find('.//ns2:docAcceptance/ns2:deliveryAcceptDate', ns).text = tree.find(
        './/ns2:docAcceptance/ns2:deliveryAcceptDate', ns).text
